...
const projects: Record<CategoryId, PortfolioProject[]> = {
  ...
  poster: [
    ...
    {
      id: 10,
      title: 'Making Space Accessible',
      category: 'Aerospace Poster',
      image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/10-uh3DaS33EZyPKgifNhWU66m0JU7XUL.png',
      size: 'large',
    },
  ],
  carousel: [
